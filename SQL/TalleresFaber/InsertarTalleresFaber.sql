...
('1122 ABC','Citroen','C3','Azul','2006-08-16','00009'),
('2233 ABC','Ford','Mondeo','Gris','2008-06-21','00002'),
('3344 ABC','Nissan','Primera','Negro','2006-03-22','00009'),
('4455 ABC','Seat','León','Rojo','2001-01-19','00005'),
('5566 ABC','Daewo','','Azul','2006-08-16','00008'),
('6677 ABC','Renault','Megane','Azul','2009-10-12','00004'),
('7788 ABC','Opel','Corsa Personality','Negro','2010-11-26','00003'),
('8899 ABC','BMW','X3','Verde','2009-01-05','00002'),
('9900 ABC','Renault','Laguna','Rojo','2010-11-06','00001'),
('0011 ABC','Hyundai','Tucson','Negro','2010-09-22','00007'),
('1111 DEF','Suzuki','Vitara','Gris','2010-05-30','00006'),
('1212 DEF','Citroen','C4','Azul','2009-07-07','00010'),
('1313 DEF','Seat','Ibiza','Gris','2009-12-23','00003'),
('1414 DEF','Volkswagen','Golf','Azul','2010-08-15','00004'),
('1515 DEF','Renault','Clio','Gris','2004-04-23','00010'),
